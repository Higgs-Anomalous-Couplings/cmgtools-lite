...
from CMGTools.TTHAnalysis.postprocessing.framework.branchselection import BranchSelection
from CMGTools.TTHAnalysis.postprocessing.framework.datamodel import InputTree
from CMGTools.TTHAnalysis.postprocessing.framework.eventloop import eventLoop
from CMGTools.TTHAnalysis.postprocessing.framework.output import FriendOutput, FullOutput
from CMGTools.TTHAnalysis.postprocessing.framework.preskimming import preSkim

class PostProcessor :
    def __init__(self,treename,outputDir,inputFiles,cut=None,branchsel=None,modules=[],compression="LZMA:9",friend=False,postfix=None,json=None,noOut=False,justcount=False,eventRange=None):
